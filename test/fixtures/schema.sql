...
--
CREATE SEQUENCE auto_incrementing_pk_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
--
...
ALTER COLUMN id
SET DEFAULT nextval('auto_incrementing_pk_id_seq'::regclass);
--
...
ALTER COLUMN id
SET DEFAULT nextval('items_id_seq'::regclass);
--
